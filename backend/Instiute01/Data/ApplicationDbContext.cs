...
namespace Instiute01.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<RecentylyPlacedStudents> RecentylyPlacedStudents { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RecentylyPlacedStudents>().HasKey(s => s.StudentId); // Define primary key explicitly if needed
